...
@patch.object(kw, "deepseek_v41_triton_warmup")
...
def test_kernel_warmup(mock_rej, mock_pen, mock_rms, mock_logger, mock_v41):
    ...
    mock_v41.assert_called_once_with(worker)
